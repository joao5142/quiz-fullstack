<template>
  <div class="container">
    ...
    <p class="mb-3">Last updated: June 12, 2024</p>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to Frontend Quiz App, the software program provided by
          the Company.
        </p>
      </li>
      <li>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Frontend Quiz App.
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: joaopauloneto3687@gmail.com</li>
    </ul>
  </div>
</template>
